...
class Client { // Client data
	...
	//    "Captain", "Dynamo",
	//];
	const nouns = ["Piet", "Bar", "Brick", "Mortar", "Trowel", "Scaffold", "Blueprint", "Cement", "Plumb", "Level", "Hammer", "Nail", "Sledge", "Chisel", "Goggles", "Helmet", "Gloves", "Boots", "Wheelbarrow", "Mixer", "Bucket", "Tape", "Measure", "Ladder", "Drill", "Screw", "Bolt", "Wrench", "Saw", "Blade", "Dust", "Mask", "Grit", "Grout", "Tile", "Panel", "Stud", "Beam", "Joist", "Rafter", "Plank", "Board", "Sheet", "Plywood", "Concrete", "Rebar", "Shovel", "Pickaxe", "Jackhammer", "Crane", "Hoist", "Pulley"];
